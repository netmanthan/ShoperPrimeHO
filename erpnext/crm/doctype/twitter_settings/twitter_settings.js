...
frappe.ui.form.on('Twitter Settings', {
	onload: function(frm) {
		...
		frm.dashboard.set_headline(__("For more information, {0}.", [`<a target='_blank' href='https://docs.shopersolutions.com/docs/user/manual/en/CRM/twitter-settings'>${__('click here')}</a>`]));
	},
